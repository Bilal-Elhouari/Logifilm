...
interface SelectPaymentMethodMacProps {
  value: string;
  onChange: (value: string) => void;
  dark: boolean;
}
...
interface SelectAllowanceMacProps {
  kind: AllowanceKind;
  value: string;
...
function SelectPaymentMethodMac({ value, onChange, dark }: SelectPaymentMethodMacProps) {
  return (
    <div className="flex flex-col">
      <label
        className={`font-semibold mb-1 text-xs ${dark ? "text-gray-200" : "text-gray-800"
...
/* ---------------- SELECT ALLOWANCE ---------------- */
function SelectAllowanceMac({
  kind,
  value,
  onKindChange,
  onValueChange,
  dark,
}: SelectAllowanceMacProps) {
  return (
    <div className="flex flex-col">
      <label
        className={`font-semibold mb-1 text-xs ${dark ? "text-gray-200" : "text-gray-800"
